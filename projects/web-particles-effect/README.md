...
| gravityStrength | number | 0.08 | 鼠标引力/斥力强度系数 |
| gravityMaxDistance | number | 200 | 鼠标引力/斥力最大作用距离（像素） |
| maxSpeed | number | 2.5 | 粒子最大速度限制 |
| damping | number | 0.98 | 速度阻尼系数 |

## 效果模式

页面右上角提供了效果模式切换按钮，支持三种模式：

| 模式 | 描述 | 交互行为 |
|------|------|----------|
| 普通效果 | 粒子自由漂浮，不受鼠标影响 | 无 |
| 引力效果 | 粒子会受到鼠标位置的引力作用 | 距离越近，吸引力越强 |
| 斥力效果 | 粒子会受到鼠标位置的斥力作用，主动躲避 | 距离越近，排斥力越强 |
